...
from models.blocks import SARDB, ChannelAttention
...
class BackBone(nn.Module):
    def __init__(self, nf, num_stage, num_rdb=2, num_dense_layer=3, growth_rate=64):
        ...
        total_channals = (num_stage + 1) * nf

        self.CA = ChannelAttention(total_channals)
        self.conv_1x1 = nn.Conv2d(total_channals, nf, kernel_size=1, padding=0)
